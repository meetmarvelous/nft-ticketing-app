      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-white/60 text-sm mb-4">
              Secure, transparent, and verifiable event ticketing powered by blockchain technology.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-white/40 text-sm">
            © {currentYear} NFT Tickets. All rights reserved.
          </p>
          <div className="flex items-center gap-2 text-white/40 text-sm">
            <span>Built on</span>
            <span className="font-semibold text-white/60">Ethereum</span>
            <span>•</span>
            <span>Deployed on</span>
            <span className="font-semibold text-white/60">Sepolia Testnet</span>
          </div>
        </div>
      </div>
    </footer>
